                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="month" name="simPeriode" id="simPeriode" value="{{ date('Y-m') }}"
                                        class="form-control col-md-12 rounded-0">
                                </div>
                                <div class="form-group col-md-2">
                                    <strong>Set</strong>
                                    <select name="simNull" id="simNull" class="form-control rounded-0 col-md-12"
                                ...
                                <div class="form-group col-md-2">
                                    <strong>Jenis</strong>
                                    <select name="simJenis" id="simJenis" class="form-control rounded-0 col-md-12"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="number" name="simJml" id="simJml"
                                        class="form-control col-md-12 rounded-0 " placeholder="Jumlah Simpanan" required>
                                </div>
                                <div class="form-group col-md-2 float-right">
                                    <strong> </strong>
                                    <br>
                                    <button id="sendSelected"
                                        class="form-control btn-success rounded-0 col-md-12 ">Update</button>
                                </div>
                            </div>
